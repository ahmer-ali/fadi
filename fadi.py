...
def main_apv():
    ...
    try:
        ...
        print ("[*]--------------------------------------------------------------")
        time.sleep(6)
        os.system("xdg-open https://wa.me/+923171168085")
        
    r1=requests.get("https://raw.githubusercontent.com/ahmer-ali/fadi/main/server.txt").text
    if key1 in r1:
        R()
    else:
        os.system("clear")
        ...
        print ("[*]--------------------------------------------------------------")
        time.sleep(3.5)
        os.system("xdg-open https://wa.me/+931171168085")
